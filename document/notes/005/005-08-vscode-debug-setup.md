...
Cinux 项目配置了完整的 VSCode 调试环境，支持通过 GDB 远程调试 QEMU 中运行的内核。配置文件位于 [`.vscode/`](../../.vscode/) 目录。
...
文件：[`.vscode/launch.json`](../../.vscode/launch.json)
...
文件：[`.vscode/tasks.json`](../../.vscode/tasks.json)
...
来源：[`cmake/qemu.cmake`](../../cmake/qemu.cmake:71-77)
...
文件：[`.vscode/gdbinit`](../../.vscode/gdbinit)
...
VSCode 操作：
1. 打开 [`main_test.cpp`](../../kernel/mini/test/main_test.cpp:20)
2. 在第 22 行点击左侧，设置断点
3. 按 F5 启动调试
4. 程序会在断点处暂停
...
- [`cmake/qemu.cmake`](../../cmake/qemu.cmake) - QEMU 配置
