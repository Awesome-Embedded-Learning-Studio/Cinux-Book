...
| 文件 | 描述 |
|---|---|
| [`test/framework/test_framework.h`](../../test/framework/test_framework.h) | 自研轻量测试框架 |

### Host 测试
| 文件 | 描述 |
|---|---|
| [`test/CMakeLists.txt`](../../test/CMakeLists.txt) | Host 测试构建配置 |
| [`test/unit/test_smoke.cpp`](../../test/unit/test_smoke.cpp) | 冒烟测试 |
| [`test/unit/test_kprintf_format.cpp`](../../test/unit/test_kprintf_format.cpp) | 格式化函数测试 |

### 内核测试
| 文件 | 描述 |
|---|---|
| [`kernel/mini/test/CMakeLists.txt`](../../kernel/mini/test/CMakeLists.txt) | 内核测试构建配置 |
| [`kernel/mini/test/main_test.cpp`](../../kernel/mini/test/main_test.cpp) | 内核测试入口 |
| [`kernel/mini/test/test_cpp_basic.cpp`](../../kernel/mini/test/test_cpp_basic.cpp) | C++ 运行时测试 |

### 自动化
| 文件 | 描述 |
|---|---|
| [`scripts/run_all_tests.sh.in`](../../scripts/run_all_tests.sh.in) | 测试运行脚本模板 |
| [`cmake/qemu.cmake`](../../cmake/qemu.cmake) | QEMU 测试配置 |
