---
title: Lab 004 · Buddy PMM 与 Slab 验证
---

# Lab 004 · Buddy PMM 与 Slab 验证

> 对应 `document/book/13-memory-advanced/004/`。验证档 **B 档**(分配器重构)。验证靠构建 + 测试 + grep + 分配密度。
...
```bash
git checkout 004_mm_buddy_slab 2>/dev/null || git checkout 004_*
