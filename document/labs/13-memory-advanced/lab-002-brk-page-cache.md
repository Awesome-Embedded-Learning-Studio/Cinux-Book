---
title: Lab 002 · brk 与 Page Cache 验证
---

# Lab 002 · brk 与 Page Cache 验证

> 对应 `document/book/13-memory-advanced/002/`。验证档 **A 档**(brk/文件 mmap 端到端可见)。验证靠构建 + 测试 + grep + 命中计数。
...
```bash
git checkout 002_brk_page_cache 2>/dev/null || git checkout 002_*
