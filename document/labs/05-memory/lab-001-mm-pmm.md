---
title: Lab 001 · 给内核一本物理内存账本:bitmap PMM
---

# Lab 001 · 给内核一本物理内存账本:bitmap PMM

> 配套章节:[001 · 给物理内存建账本:bitmap 物理内存管理器](../../book/05-memory/001/)。这一关给你目标和约束,不贴答案——bitmap 放哪、init 怎么 carve,都得你自己想清楚。
