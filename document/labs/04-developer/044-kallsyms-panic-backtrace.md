---
title: Lab 044 · kallsyms 与 panic backtrace 验证
---

# Lab 044 · kallsyms 与 panic backtrace 验证

> 对应 `document/book/04-developer/044-kallsyms-panic-backtrace.md`。验证档 **C 档**(调试路径)。验证靠触发 panic 看符号化栈 + grep。
...
```bash
git checkout 044_dev_kallsyms_panic 2>/dev/null || git checkout 044_*
