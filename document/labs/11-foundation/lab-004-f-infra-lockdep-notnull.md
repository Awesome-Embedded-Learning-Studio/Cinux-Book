---
title: Lab 004 · F-INFRA 基建加固 验证
---

# Lab 004 · F-INFRA 基建加固 验证

> 对应 `document/book/11-foundation/004/`。验证档 **B/C 档**。验证靠构建 + grep + 开 lockdep 跑测试。
...
```bash
git checkout 004_f_infra_lockdep 2>/dev/null || git checkout 004_*
