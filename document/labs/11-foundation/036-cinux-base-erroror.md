---
title: Lab 036 · Cinux-Base 与 ErrorOr 验证
---

# Lab 036 · Cinux-Base 与 ErrorOr 验证

> 对应章节:`document/book/11-foundation/036-cinux-base-erroror.md`。
...
```bash
git checkout 036_foundation_cinux_base     # 切到本 tag 的源码状态
