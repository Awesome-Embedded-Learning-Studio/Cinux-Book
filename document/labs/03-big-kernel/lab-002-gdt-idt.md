---
title: Lab 002 · 大内核 GDT/IDT
---

# Lab 002 · 大内核 GDT/IDT

> 这个 lab 配套 [002 · GDT](../../book/03-big-kernel/002/) 和 [003 · IDT 与异常](../../book/03-big-kernel/003/) 两篇。目标是亲手把 big kernel 的异常通路从零搭起来,让它能接住 `int $3`、dump 出寄存器、活着继续跑。这里只给任务、约束和验证手段,**不贴现成答案**——选择子得自己算,stub 得自己写。
...
- 已完成 001:big kernel 能被 mini kernel 加载、能跑 `kprintf` 往串口输出。
