---
title: Lab 050 · ACPI 与 APIC 验证
---

# Lab 050 · ACPI 与 APIC 验证

> 对应 `document/book/15-smp/050-acpi-apic.md`。验证档 **B 档**(启动日志见 APIC 切换 + PIT 走时)。验证靠构建 + 测试 + grep + 启动日志。
...
```bash
git checkout 050_smp_acpi_apic 2>/dev/null || git checkout 050_*
