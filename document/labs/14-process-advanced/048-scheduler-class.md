---
title: Lab 048 · 调度类与 SIGSTOP/CONT 验证
---

# Lab 048 · 调度类与 SIGSTOP/CONT 验证

> 对应 `document/book/14-process-advanced/048-scheduler-class.md`。验证档 **A 档**(SIGSTOP/CONT 可见)。验证靠构建 + 测试 + grep + STOP/CONT。
...
```bash
git checkout 048_proc_scheduler_class 2>/dev/null || git checkout 048_*
