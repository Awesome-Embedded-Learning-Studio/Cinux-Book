...
- 完成 [Lab 003](lab-003-mini-kernel-intr.md):内核有 kprintf、GDT/IDT/异常、QEMU 测试框架。
...
串口出现 `ATA controller initialized`、`MBR boot signature: 0xaa55 (VALID)`、`No valid ELF header at LBA 16 (expected for flat binary)`、最后 `Milestone 004 complete. Waiting for big kernel (009+)...`。
