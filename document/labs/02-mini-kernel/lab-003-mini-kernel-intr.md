---
title: Lab 003 · 第一次能被打断
---

# Lab 003 · 第一次能被打断

> 这个 lab 配套 [003 · 第一次能被打断](../../book/02-mini-kernel/003/)。目标:给 mini kernel 装自己的 GDT 和 IDT,写 ISR stub,接住 `int $3`(#BP)和页错误(#PF),dump 寄存器后活着继续。**GDT 描述符自己拼位、IDT 门自己编码、stub 压栈顺序自己定**,不给现成答案。
...
- 完成 [Lab 002](lab-002-mini-kernel-pmm.md):内核有 kprintf、PMM、QEMU 测试框架。
