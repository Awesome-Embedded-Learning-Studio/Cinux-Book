---
title: Lab 001 · 内核会说话了
---

# Lab 001 · 内核会说话了

> 这个 lab 配套 [001 · 内核会说话了](../../book/02-mini-kernel/001/)。目标:给 mini kernel 写串口驱动 + kprintf,并给格式化算法配一套 host 单测,再在 QEMU 里跑内核测试。**UART 寄存器自己配、格式化算法自己写、测试断言自己定**,不给现成答案。
...
- 全程轮询、无中断;没碰 PMM/堆——那是 [Lab 002](lab-002-mini-kernel-pmm.md) 的事。
