...
> 从 `document/notes/002/1.md`、`document/notes/002/2.md` 提炼,配套 [`01-boot/002` · 进入保护模式](../book/01-boot/002/)。实模式 → 保护模式这一跳,要在几条指令内同时切换寻址模型、译码宽度、CS 来源,几乎每个环节都能独立制造一次三重故障。下面是三个最常要命的。
