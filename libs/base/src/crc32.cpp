/**
 * @file crc32.cpp
 * @brief CRC32 implementation with lookup table.
 *
 * Migrated from kernel/mini/lib/crc32.h, namespace changed to cinux::lib.
 * The lookup table is file-local to avoid symbol duplication across TUs.
 */
