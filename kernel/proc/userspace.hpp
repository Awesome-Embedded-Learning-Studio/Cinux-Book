 ...
 *   - CINUX_GUI on  -> kernel/gui/desktop_launch.cpp (fork+execve userspace GUI host)
...
/// Bring up userspace after the VFS is mounted.  GUI build: fork+execve the
/// userspace GUI host (/cinux_gui_host) after arming mouse + keyboard input.
